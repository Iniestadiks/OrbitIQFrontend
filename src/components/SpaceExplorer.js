...
function SpaceExplorer() {
  ...
  useEffect(() => {
    ...
    function onMouseClick(event) {
        ...
        // Mise à jour des coordonnées de la souris en fonction de la taille actuelle et de la position du canvas de rendu
        ...
        // Mettre à jour le raycaster avec les nouvelles coordonnées de la souris
        raycaster.setFromCamera(mouse, camera);
        const intersects = raycaster.intersectObjects(scene.children, true);
    
        // Boucle à travers l'ensemble des intersections
    ...
    <div style={{ position: "relative", width: '100vw', height: '100vh' }}>
      <div style={{
        ...
        <div>
          ...
          <input id="speedSlider" type="range" min="100" max="200" step="0.01" value={rotationSpeed} onChange={e => setRotationSpeed(parseFloat(e.target.value))} />
        </div>
        <div>
