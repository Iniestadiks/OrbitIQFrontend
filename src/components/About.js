    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', textAlign: 'center' }}>
            ...
            <div className="team-section" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '40px' }}>
                ...
                <div className="team-row" style={{ display: 'flex', justifyContent: 'center', gap: '20px' }}>
                    <div className="team-member">
                ...
                <div className="team-row" style={{ display: 'flex', justifyContent: 'center', gap: '20px' }}>
                    <div className="team-member">
                        ...
                        <h3>Madicke (AW)</h3>
                        <p>Développeur Front-End - Madicke combine son amour pour le design et la programmation web en générale pour créer des expériences utilisateur inoubliables.</p>
                    </div>
                    <div className="team-member">
